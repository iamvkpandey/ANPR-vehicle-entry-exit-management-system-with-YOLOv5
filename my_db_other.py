...
# db= mysql.connector.connect(host="localhost", user="root", database = "my_test")
# mycourser=db.cursor()
...
class dbhelper:
    def __init__(self):
        ...
        try:
            self.conn=mysql.connector.connect(host="localhost", user="root", database="my_test") # alway check this one from line 13 
